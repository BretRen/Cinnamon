...
import com.sosauce.cinnamon.ui.screens.contacts.ContactDetailsAction
import com.sosauce.cinnamon.ui.screens.contacts.components.dialogs.NumberPickerDialog
    ...
    val actions = buildList {
                ...
                ContactActionsItem(
                    ...
                    onClick = {
                        if (contact.phoneNumbers.size > 1) {
                            ...
                            val threadId = contact.phoneNumbers.first().number.getThreadIdOrCreate(context)
        ...
        add(
            ContactActionsItem(
                ...
                onClick = { onHandleContactDetailsAction(ContactDetailsAction.ToggleFavorite(contact.isFavorite)) },
