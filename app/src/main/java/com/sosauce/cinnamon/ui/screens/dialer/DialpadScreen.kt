...
import com.sosauce.cinnamon.ui.screens.contacts.groupedContactsList
import com.sosauce.cinnamon.ui.screens.phone.CallAction
import com.sosauce.cinnamon.ui.screens.phone.components.DisableSoftKeyboard
    ...
    if (state.isLoading) {
        ...
        Scaffold(
            ...
            LazyColumn(
                ...
                groupedContactsList(
                    contacts = state.contacts.fastFilter { it.phoneNumbers.fastAny { number -> number.number.contains(value) } },
